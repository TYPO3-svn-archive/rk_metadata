 ...
 */
class tx_rkmetadata_pi1 extends tslib_pibase {
	var $prefixId      = 'tx_rkmetadata_pi1';		// Same as class name
	var $scriptRelPath = 'pi1/class.tx_rkmetadata_pi1.php';	// Path to this script relative to the extension dir.
	var $extKey        = 'rk_metadata';	// The extension key.
	...
	function renderMetadata($content,$conf)	{
		...
		$this->s_keyWords = $this->replaceDynamicData( $a_alternativePageContent['tx_rkmetadata_keywords_layout'] ); // Get the dynamic page keywords
		$this->s_description = $this->replaceDynamicData( $a_alternativePageContent['tx_rkmetadata_descriptions_layout'] ); // Get the dynamic page description
		$this->s_title = $this->replaceDynamicData( $a_alternativePageContent['tx_rkmetadata_titletag'] ); // Get the dynamic page title
